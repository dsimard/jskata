...
h3. forloop(wh, inc, fct, options{sleepFor:integer, chunkSize:integer}, stopCallback) returns [stop]
...
h3. infinite(fct, options, stopCallback) returns [stop]
...
h3. each(obj, fct(index, item), options, stopCallback) returns [stop]
